//
//  Custom2CombinedChartView.swift
//  Charts
//
...
open class CustomCombinedChartView: BarLineChartViewBase, CombinedChartDataProvider
{
    /// the fill-formatter used for determining the position of the fill-line
    internal var _fillFormatter: FillFormatter!
    
    /// enum that allows to specify the order in which the different data objects for the combined-chart are drawn
    @objc(Custom2CombinedChartDrawOrder)
    ...
    open override var data: ChartData?
    {
        ...
        set
        {
            ...
            (renderer as? CustomCombinedChartRenderer)?.createRenderers()
